...
#define BUTTON_1X		0x00000010l	// Ｘボタン(.rgbButtons[0]&0x80)
#define BUTTON_2Y		0x00000020l	// Ａボタン(.rgbButtons[1]&0x80)
#define BUTTON_3A		0x00000040l	// Ｂボタン(.rgbButtons[2]&0x80)
#define BUTTON_4B		0x00000080l	// Ｙボタン(.rgbButtons[3]&0x80)
